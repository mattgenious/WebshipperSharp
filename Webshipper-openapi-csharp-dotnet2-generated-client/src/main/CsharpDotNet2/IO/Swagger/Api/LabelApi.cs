...
namespace IO.Swagger.Api
{
    ...
    public class LabelApi : ILabelApi
    {
        ...
        /// <param name="filterId">Filter by id</param>
        /// <returns>InlineResponse20049</returns>
        public InlineResponse20049 LabelsGet (string filterId)
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling LabelsGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling LabelsGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="id"></param>
        /// <returns>InlineResponse20048</returns>
        public InlineResponse20048 LabelsIdGet (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null) throw new ApiException(400, "Missing required parameter 'id' when calling LabelsIdGet");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling LabelsIdGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling LabelsIdGet: " + response.ErrorMessage, response.ErrorMessage);
