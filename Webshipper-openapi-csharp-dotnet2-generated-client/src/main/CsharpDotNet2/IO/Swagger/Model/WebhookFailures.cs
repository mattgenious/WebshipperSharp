...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class WebhookFailures {
    /// <summary>
    /// The id of the record the webhook failed to send
    /// </summary>
    /// <value>The id of the record the webhook failed to send</value>
    ...
    /// </summary>
    /// <value>Title of the failure</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class WebhookFailures {\n");
